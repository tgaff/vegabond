...
three = Post.create({title:"The bar", city: melbourne, story:"Went to the bar, got kicked out", author:"Ash"})

four = Post.create({title:"The restaurant", city:sanfrancisco, story:"Best soup in the world", author:"Ash"})
